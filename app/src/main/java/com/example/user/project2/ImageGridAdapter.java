...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, ArrayList<String> imageIDs) {
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null != convertView)
            ...
            byte[] decodedString = Base64.decode(imageIDs.get(position), Base64.DEFAULT);
...
//                   = new ImageClickListener(context, imageIDs.get(position));
